...
@section('main-content')
    <div class="content">
        ...
        <div class="row">
            <form action="{{ route('warga.update', Crypt::encrypt($data->id)) }}" method="POST"
                ...
                <div class="col-lg-4 order-lg-2">
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            <img id="preview"
                                src="{{ $data->photo == null ? asset('images/preview.png') : $data->photo }}"
                                class="rounded-circle" width="200px" height="200px" />
                            <div class="card-body mt-3">
                                <input accept="image/*" type='file' id="photo" class="form-control " name="photo"
                                    value="{{ old('photo') }}" />
                                @if ($errors->has('photo'))
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="nama_lengkap" type="text" class="form-control" id="nama_lengkap"
                                        required placeholder="Nama Lengkap" value="{{ $data->nama_lengkap }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <textarea name="alamat" placeholder="Alamat" required class="form-control" id="alamat">{{ $data->alamat }}</textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="pekerjaan" type="text" class="form-control" required id="pekerjaan"
                                    ...
                                    <div class="form-group{{ $errors->has('agama') ? ' has-error' : '' }}">
                                        ...
                                        <select class="form-control" name="agama" required="">
                                            ...
                                            <option value="Kong Hu Chu"
                                                {{ $data->agama == 'Kong Hu Chu' ? 'selected' : '' }}>Kong Hu Chu</option>
                                        </select>
                                        @if ($errors->has('agama'))
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input name="tempat_lahir" type="text" class="form-control" required
                                        placeholder="Tempat Lahir" id="tempat_lahir" value="{{ $data->tempat_lahir }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="telepon" type="text" class="form-control" required
                                        placeholder="No. Telephone" id="telepon" value="{{ $data->telepon }}">
