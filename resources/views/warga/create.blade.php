                ...
                <div class="col-lg-4 order-lg-2">
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            <img id="preview" src="{{ asset('images/preview.png') }}" class="rounded-circle"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="nama_lengkap" type="text" class="form-control" id="nama_lengkap" require
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="pekerjaan" type="text" class="form-control" require id="pekerjaan"
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input name="tempat_lahir" type="text" class="form-control" require
                                        placeholder="Tempat Lahir" id="tempat_lahir" value="{{ old('tempat_lahir') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="telepon" type="text" class="form-control" require
                                        placeholder="No. Telephone" id="telepon" value="{{ old('telepon') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input name="username" type="text" placeholder="Username" require
                                        class="form-control" id="username" value="{{ old('username') }}">
