                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <input name="tanggal_kegiatan" type="datetime-local" class="form-control" require id="tanggal_kegiatan" placeholder="Tanggal Kegiatan" value="{{old('tanggal_kegiatan')}}">
