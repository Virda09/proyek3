                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <input name="nama" type="text" class="form-control" id="nama" require placeholder="Nama Kegiatan" value="{{$data->name}}">
                                @if ($errors->has('nama'))
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <input name="tanggal_kegiatan" type="datetime" class="form-control" require id="tanggal_kegiatan" placeholder="Tanggal Kegiatan" value="{{$data->tanggal_kegiatan}}">
